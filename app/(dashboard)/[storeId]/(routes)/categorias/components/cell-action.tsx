...
import { Copy, Edit, MoreHorizontal, X, Loader } from "lucide-react";
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Asegúrate de haber eliminado todas los productos que esta categoría contiene antes de eliminarla."
      );
    } finally {
      setLoading(false);
      setOpen(false);
